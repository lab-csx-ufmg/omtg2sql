...
/
-- Add new column (foreign key) on table cidade due conventional-relationship-cidade-contem-bairro
ALTER TABLE cidade ADD (
  bairro_idBairro NUMBER(5,0)
);
/
-- Add foreign key constraint on table cidade due conventional-relationship-cidade-contem-bairro
ALTER TABLE cidade ADD
