package omtg2sql.core;

import java.util.List;

import omtg2sql.omtg.classes.OMTGCardinality;
import omtg2sql.omtg.classes.OMTGClass;
import omtg2sql.omtg.model.OMTGSchema;
import omtg2sql.omtg.model.OMTGSchemaLoader;
...
import omtg2sql.omtg.relationships.OMTGConventionalRelationship;
...
import omtg2sql.sql.oracle.SQLGenerator;
...
//		try {
//			if (args.length != 1) {
//				throw new Exception("You must specify one OMT-G schema in an XML document format as input.");
//			}
			
			String xmlDoc = "omtg-schemas/case-study-1.xml";
